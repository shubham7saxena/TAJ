...
urlpatterns = patterns('',
	...
	url(r'^performanceCumulative/(?P<courseId>\d+)/$', views.performanceCumulative, name='index'),
	#url(r'^performanceIndividual/(?P<courseId>\d+)/$', views.performanceIndividual, name='index'),
